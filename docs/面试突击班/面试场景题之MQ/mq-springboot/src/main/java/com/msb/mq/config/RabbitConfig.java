...
import com.msb.mq.service.rabbit.Receiver;
...
public class RabbitConfig {
    ...
    //TODO rabbitAdmin类封装对RabbitMQ的管理操作(包括创建 交换器。队列，绑定关系)
    @Bean
    ...
    public Queue queueTTL() {
        ...
        // 队列中消息的最大数量---这里可以利用死信交换器去处理消息积压问题
    ...
    public SimpleMessageListenerContainer messageContainer() {
     ...
     //配置 SimpleMessageListenerContainer 来设置消费者的预取数量
    @Bean
