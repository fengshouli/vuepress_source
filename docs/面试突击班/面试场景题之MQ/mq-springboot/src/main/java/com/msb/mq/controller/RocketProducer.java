...
public class RocketProducer {
    ...
    public String sendDelay() throws Exception{ //mq的消息发送
        ...
        //4.x 只有这种方式 delayTimeLevel：(1~18个等级)"1s 5s 10s 30s 1m 2m 3m 4m 5m 6m 7m 8m 9m 10m 20m 30m 1h 2h"

        //在 RocketM 4.X  只能玩18个等级（收费版可以aliyun，apache开源不行）， 到5版本的是可以---自定义的、
