...
VALUES ( 'pgrm_project_task_import', 'import', 'taskWorkbenchImportCommonRule', 10.00, NULL, '0', NULL, '', NULL, NULL, 0, NULL, NULL, NULL, '～');
```
...
```sql
INSERT INTO `billruleregister` ( `billnum`, `action`, `ruleId`, `iorder`, `overrule`, `tenant_id`, `key`, `isSystem`, `url`, `config`, `isAsyn`, `domain`, `dataRule`, `mock`, `ytenant_id`)
VALUES ( 'pgrm_project_task_import', 'import', 'importExcelUpdateExRule', 11.00, NULL, 'iczyv482', NULL, '', NULL, NULL, 0, NULL, NULL, NULL, '~');

INSERT INTO `billruleregister` ( `billnum`, `action`, `ruleId`, `iorder`, `overrule`, `tenant_id`, `key`, `isSystem`, `url`, `config`, `isAsyn`, `domain`, `dataRule`, `mock`, `ytenant_id`)
VALUES ( 'pgrm_project_task_import', 'import', 'importExcelUpdateExRule', 11.00, NULL, 'iczyv482', NULL, '', NULL, NULL, 0, NULL, NULL, NULL, 'iczyv482');
