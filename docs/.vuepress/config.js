module.exports = {
    ...
    themeConfig: {
        ...
        sidebar: {
            ...
            "/源码解析/":["","springboot源码解析"],
            "/程序员英语/":["","程序员英语"],
            "/算法体系/":["","算法基础","算法新手班","7-堆-被火车撞了都不能忘记的结构","11-二叉树.md","18-暴力递归到动态规划","25-滑动窗口内最大值或最小值问题","26-单调栈","28-KMP算法","29-Manacher算法","30-蓄水池算法","31-Morris遍历","32-线段树","34-与哈希函数有关的数据结构","docs/算法体系/35-资源限制类题目解题思路.md"],
